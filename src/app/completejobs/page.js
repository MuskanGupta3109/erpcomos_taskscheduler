    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                const res = await axios.get(`${apiurl}/admin/completejob/${testValue}`, { cache: 'no-store' });
                console.log(res)
                ...
                console.log(typeof (jsonData.data.length))
                            ...
                            <tbody>
                                {data.slice(startindex, limit).map((jobs, index) => (
                                    ...
                                    <tr key={jobs.data1.id}>
                                        ...
                                        <td>{JSON.parse(jobs.data1.product).name}</td>
